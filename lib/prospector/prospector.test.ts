...
import { MOCK_PROSPECTS, highAbilityProspects } from "@/lib/prospector-data";
import { parseProspectCsv } from "@/lib/prospector/import";
import { REGIONS, listRegions } from "@/lib/regions/config";
