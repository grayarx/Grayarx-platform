import { ingestLead, type Lead, type LeadSource } from "@nalaOs/conversion/leads";
import { sendWhatsApp } from "@nalaOs/whatsapp/send";
import { emitCrmEvent } from "@nalaOs/crm/webhooks";
import { routeBranchByCity, ensureBranches } from "@nalaOs/branches/store";
import { getStock } from "@nalaOs/conversion/stock";
import { ensureMultiBranchStock } from "@nalaOs/branches/store";
import { writeJsonFile } from "@nalaOs/conversion/store";
