import { ingestLead, bookViewing, type Lead, type Booking } from "@nalaOs/conversion/leads";
import { holdPart, quotePart, type PartsEnquiry } from "@nalaOs/os/parts";
import { bookService, type ServiceBooking } from "@nalaOs/os/service";
import { captureTradeIn, type TradeIn } from "@nalaOs/os/tradein";
import { startFinancePrequal, type FinanceApplication } from "@nalaOs/finance/prequal";
import { sendWhatsApp, type WhatsAppMessage } from "@nalaOs/whatsapp/send";
import { emitCrmEvent, type CrmDelivery } from "@nalaOs/crm/webhooks";
import { routeBranchByCity } from "@nalaOs/branches/store";
import { formatVehicleLine, findVehicle } from "@nalaOs/conversion/stock";
