import { readJsonFile, writeJsonFile } from "@nalaOs/conversion/store";
import {
  getDealershipSettings,
  updateDealershipSettings,
  type DealershipModules,
} from "@nalaOs/dealership/settings";
import { listAvailable } from "@nalaOs/conversion/stock";
import { listAllParts } from "@nalaOs/os/parts";
import { listCrmSubscriptions } from "@nalaOs/crm/webhooks";
