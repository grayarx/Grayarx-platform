...
const ADMIN_LINKS = [
  ...
  { href: "/admin/os", label: "Dealership OS", icon: Bot, founderOnly: true },
  { href: "/admin/pricing", label: "OS pricing", icon: Wallet, founderOnly: true },
  { href: "/admin/competitors", label: "Competitors", icon: Megaphone, founderOnly: true },
